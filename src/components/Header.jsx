...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden object-fit:cover' style={{ backgroundImage: `url(${home6})` }} id='Header'>
